About cdat_info-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cdat_info-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3808&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cdat_info-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cdat_info` can be installed with `conda`:
...
```
mamba install cdat_info
```

It is possible to list all of the versions of `cdat_info` available on your platform with `conda`:
...
```
mamba search cdat_info --channel conda-forge
```
...
mamba repoquery search cdat_info --channel conda-forge

# List packages depending on `cdat_info`:
mamba repoquery whoneeds cdat_info --channel conda-forge

# List dependencies of `cdat_info`:
mamba repoquery depends cdat_info --channel conda-forge
```
